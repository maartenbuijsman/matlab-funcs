%% function [period,freq,power,YReIm] = fft_spectra2_expReIm(t,y,tukey,numwin)
...
%     YReIm complex amplitude => e.g. if you want to compute cross-spectra
%
...
function [period,freq,power,YReIm] = fft_spectra2_expReIm(t1,y1,tukey,numwin);
