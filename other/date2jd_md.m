function jd = date2jd_md(varargin)
% modified by Maarten Buijsman, UCLA, 24-01-08: day starts at midnight
% http://home.online.no/~pjacklam/matlab/software/util/timeutil/index.html
% NOTE date2jd_md(-4713,11,24,0) gives 0
% do tests
% [y,m,d,h]=jd2date_md(0), mjd0 = date2jd_md(y,m,d,h)
% [y,m,d,h]=jd2date(0),    mjd0 = date2jd(y,m,d,h)
%
...
%   URL:         http://home.online.no/~pjacklam
   ...
   jd = jd+0.5; % subtract half a day to start at midnight MCB 24-01-08
