function [rho1]=my_rhos(Tt,Ts,z_r,z_w,g,rho0)
%function [rho1,bvf]=my_rho_eos(Tt,Ts,z_r,z_w,g,rho0)
% rho1 is potential density, rho increases with depth due to pressure (MCB2009/04/13)
% exclude computation of bvf, to speed it up
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
